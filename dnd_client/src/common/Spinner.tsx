...
export function Spinner({ width, height, fillHtmlCode }: Props): JSX.Element {
  const _width = width || '30px';
  const _height = height || '30px';
  const _fillHtmlCode = fillHtmlCode || '#3f51b5';
  return (
    <svg
      ...
      <g transform="translate(80,50)">
        <g transform="rotate(0)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity={1}>
        ...
        <g transform="rotate(45)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.875">
        ...
        <g transform="rotate(90)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.75">
        ...
        <g transform="rotate(135)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.625">
        ...
        <g transform="rotate(180)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.5">
        ...
        <g transform="rotate(225)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.375">
        ...
        <g transform="rotate(270)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.25">
        ...
        <g transform="rotate(315)">
          <circle cx={0} cy={0} r={6} fill={_fillHtmlCode} fillOpacity="0.125">
